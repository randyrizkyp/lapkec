      ...
      <div class="main-sidemenu">			
			<ul class="side-menu">
				<li class="nav-link leading-none d-flex">
					...
					<span class="side-menu__label" style="padding-left: 5px; font-weight: bold; overflow: hidden;">{{ Str::upper(Session::get('nama')) }}<br><a style="font-size: 10px;">{{ Str::upper(Session::get('nama_opd')) }}</a></span>
				</li>				
				...
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" href="/user"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Beranda</span></a>
				</li>
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" href="/"><i class="side-menu__icon fe fe-users"></i><span class="side-menu__label">Daftar Psikolog</span></a>
				</li>
				<li class="slide">
