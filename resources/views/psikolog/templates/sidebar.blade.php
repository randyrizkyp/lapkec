   ...
   <div class="app-sidebar">
      ...
      <div class="main-sidemenu">			
			<ul class="side-menu">
				...
				<li class="slide">
					<a class="side-menu__item has-link" data-bs-toggle="slide" href="/psikolog"><i class="side-menu__icon fe fe-users"></i><span class="side-menu__label">Daftar Psikolog</span></a>
				</li>
				<li class="slide">
